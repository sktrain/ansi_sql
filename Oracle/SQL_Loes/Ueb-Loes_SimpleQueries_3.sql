...
-- ANSI-Variante (da manager_id 6 Ziffern hat -> besser varchar(6))
SELECT 	last_name, 
			COALESCE(CAST(manager_id as varchar(6)), 'No Manager') "Manager"
FROM	 employees; 

-- oder mit Oracle-spezifischer Variante
SELECT 	last_name,
