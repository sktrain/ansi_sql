-- Übung 2: Verwendung von Datentypen und Operatoren  -  Lösungen 
...
-- 2.	Schreiben Sie eine Abfrage, die den Nachnamen und die Abteilungsnummer für den Angestellten 
...
-- deren Gehalt außerhalb des Bereichs zwischen 5.000 und 12.000 liegt.
...
ORDER BY hire_date;
-- mit ISO8601-Schreibweise (alle Elemente müssen angegeben werden!)
...
-- 7.	Zeigen Sie die Nachnamen und Gehälter aller Mitarbeiter an, die zwischen 5000 und 12000 verdienen, 
...
-- unter der Voraussetzung, dass die Jahreszahl Bestandteil der Ausgabe ist
-- genauer gesagt der Zeichenkette, die durch den impliziten Cast des Datumswerts entsteht
-- hängt von den nationalen Einstellungen ab!! und deshalb weniger glücklich
...
-- 10.	Zeigen Sie den Nachnamen, das Gehalt und die Provision für alle Mitarbeiter, die Provision bekommen. 
...
-- 11.	Zeigen Sie den Nachnamen, die Jobkennung und das Gehalt für alle Mitarbeiter, 
