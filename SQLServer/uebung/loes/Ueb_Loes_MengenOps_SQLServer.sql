-- Übung 7: Mengenoperatoren  -  Lösungen
...
-- in ihre ursprüngliche Position wie zum Zeitpunkt der Einstellung zurückgekehrt sind.	
...
-- 5. Ändern Sie die Abfrage aus Aufgabe 4 so, dass nur die Mitarbeiter angezeigt werden, 
...
-- 6. Erstellen Sie mit Hilfe von Mengenoperatoren eine Jobliste für die Abteilungen 
-- 10, 50, 20 in genau dieser Sortierreihenfolge. Zeigen Sie die Jobkennung und die 
-- Abteilungskennung an (und eventuell zusätzlich notwendige Spalten).
