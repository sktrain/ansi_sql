...
Mitarbeiter 'Kochhar' erh�lt. Kochhar soll nicht im Ergebnis enthalten sein */
...
SELECT first_name, last_name FROM employees
   WHERE employee_id NOT IN ( SELECT DISTINCT manager_id FROM employees 
                                ...
                                -- nicht vergessen, auf NOT NULL zu pr�fen!
                                );
...
anzuzeigen, deren Maximalgehalt 50% des Maximalgehalts des gesamten Unternehmens
übersteigt (sprich der Jobkennung mit dem 
höchsten Maximalwert im Unternehmen).
