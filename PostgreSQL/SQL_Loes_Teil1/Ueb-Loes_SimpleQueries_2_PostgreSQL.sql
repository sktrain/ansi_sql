...
ORDER BY hire_date;
-- vorausgesetzt das Format für das Datum “DD.MM.YY“ wird erkannt

-- oder portablere Variante
SELECT	last_name, job_id, hire_date
FROM	employees
WHERE	hire_date 
...
-- oder mit expliziter Formatfestlegung
SELECT	last_name, job_id, hire_date
FROM	employees
WHERE	hire_date 
BETWEEN to_date('01:2004:20 00.00.00', 'mm:yyyy:dd hh24.mi.ss') AND 
              to_date('05.2005.01 23.59.59', 'mm:yyyy:dd hh24.mi.ss')
ORDER BY hire_date;
