/*============================================================================
  File:     Install_HR_DB_CreateTables_1.sql

  Summary:  Creates the HR sample database - Step 1:
		Create Schema HR und Tabellen in der jeweils aktuellen Database

  Date:     15.07.2024  (Basiert auf der PostgreSQL-Variante)
  Updated:  

  Bereinigt um Constraints, da Snowflake ausser "NOT NULL" keine Constraints 
  unterstützt.
  (CHECK wird syntaktisch nicht unterstützt, alles andere wie Schlüssel
   bzw. Fremdschlüssel usw. werden ignoriert!!)
...
COMMENT ON SCHEMA hr
    IS 'HR-Schema (origin oracle)';
