...
--  Updated:
--
--  Da Snowflake keine Constraints unterstützt, brauchen auch hier keine
--  Schlüssel/Fremdschlüsselbeziehungen ein/ausgeschaltet werden!!	
-- ===========================================================================*/
...
-- ***************************insert data into the HR.employees table
